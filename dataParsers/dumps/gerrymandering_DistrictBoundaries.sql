...
CREATE TABLE `DistrictBoundaries` (
  ...
  PRIMARY KEY (`Id`),
  KEY `fk_District_idx` (`DistrictId`),
  KEY `fk_Boundary` (`BoundaryId`),
  CONSTRAINT `fk_Boundary` FOREIGN KEY (`BoundaryId`) REFERENCES `Boundaries` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_District` FOREIGN KEY (`DistrictId`) REFERENCES `Districts` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2017-11-11 20:56:51
